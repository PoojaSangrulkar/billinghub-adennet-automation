...
public class RadiusTests {
    ...
    private static String APN = "aden.com"; // Individual : aden.com VIP: adennet.vip
...
////        TimeUnit.SECONDS.sleep(5);
//        sendAccountingRequest(2);   //stop
//        SeleniumTestMethods.launchChrome();
//        SeleniumTestMethods.userLogin();
//        SeleniumTestMethods.validateHomePage();
//        SeleniumTestMethods.searchSubscriber(USER_NAME);
//        String data = SeleniumTestMethods.availableDataBeforeRun();
//        int numberofpackets = Integer.parseInt(data);
...
//                TimeUnit.SECONDS.sleep(2);
 ...
 //       TimeUnit.SECONDS.sleep(2);
//        SeleniumTestMethods.availableDataAfterRun(j);
//        SeleniumTestMethods.inspectCustomerPage(SESSION_ID,j);
